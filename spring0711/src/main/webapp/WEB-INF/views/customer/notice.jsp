...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %> <%-- 날짜 자릿수 --%>
<!DOCTYPE html>
<html>
<head>
					...
					<div class="orderDivMt">
						<table summary="NO, 제목, 등록일, 조회수 순으로 공지사항을 조회 하실수 있습니다." class="orderTable2" border="1" cellspacing="0">
							...
							<tbody>
								...
								<c:forEach var="cdto" items="${list}"><%-- var는 변수: 전체변수중 1개씩 1개씩 뿌려줌 forEach로  / CustomerController에 있는 list --%>
								<tr>
									<td class="tnone">${cdto.bno}</td>
									<td class="left">
										<a href="#" class="lightgray">${cdto.btitle}</a><%--  ${}:jstl  --%>
									</td>
